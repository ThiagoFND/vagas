package br.com.analise.vagas.dto;
...
public class VagasDTO {
	...
	public VagasDTO(Long id, String cargoVaga, Boolean java, Boolean eclipse, Boolean api, Boolean pl_sql,
